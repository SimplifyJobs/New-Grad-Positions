...
| [Palantir](https://jobs.lever.co/palantir?) | US multiple locations | search for `Software Engineer, New Grad` and `Forward Deployed Software Engineer, New Grad` in the job page | 
